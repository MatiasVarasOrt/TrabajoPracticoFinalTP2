class CancionController {
  constructor(service) {
    this.cancionService = service;
  }

  getAllCanciones = async (req, res) => {
    try {
      const canciones = await this.cancionService.getAllCanciones();
  ...
  getCancionById = async (req, res) => {
    try {
      ...
      const cancion = await this.cancionService.getCancionById(id);
  ...
  createCancion = async (req, res) => {
    try {
      const nuevaCancion = await this.cancionService.createCancion(req.body);
  ...
  updateCancion = async (req, res) => {
    try {
      const { id } = req.params;
      const cancion = await this.cancionService.updateCancion(id, req.body);
  ...
  searchCanciones = async (req, res) => {
    try {
      const { query } = req.query;
      const canciones = await this.cancionService.searchCanciones(query);
